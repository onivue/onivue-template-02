...
// 'field' is the size a form uses: the same pill and the same --control-height as every input, so a
// select never sits a few pixels off the field above it
