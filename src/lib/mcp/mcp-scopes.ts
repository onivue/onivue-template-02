...
export const MCP_SCOPE_DESCRIPTIONS: Record<string, string> = {
	...
	[MCP_SCOPE_IDS.eventsRead]: 'Deine Events, Einladungen und den Antwortstand lesen.',
	[MCP_SCOPE_IDS.eventsWrite]:
		'Events und Einladungen anlegen und pflegen. Nicht enthalten: löschen, archivieren, Links ersetzen oder für Gäste antworten.',
